...
如果 Linux 容器已经起来，但你在 Windows 浏览器里打不开，通常原因不是应用没启动，而是“你访问不到 Linux 里的 8787”。
...
```powershell
ssh -i C:\1Project\project_web\drop\.tmp\codex-linux-vm.key -p 2222 -N -L 8787:127.0.0.1:8787 admin@127.0.0.1
```
...
3. `make demo`
4. 在 Linux 桌面浏览器打开 `http://127.0.0.1:8787/`
